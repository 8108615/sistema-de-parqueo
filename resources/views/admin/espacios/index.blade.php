            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/admin/espacios/create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>
                            Crear
                            Nuevo</a>
                    </div>
                </div>
                                ...
                                <div class="modal fade" id="modal_cambiar_estado{{ $espacio->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header" style="background-color: #1f5f05;color: white;">
                                                <h5 class="modal-title" id="exampleModalLabel">Cambiar el Estado de Espacio {{ $espacio->numero }}
                                                </h5>
