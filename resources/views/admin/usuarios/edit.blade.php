                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('nombres', $usuario->nombres) }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('apellidos', $usuario->apellidos) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="tipo_documento" class="form-control" id="tipo_documento" required>
                                            ...
                                            <option value="DNI" {{ old('tipo_documento', $usuario->tipo_documento) == 'DNI' ? 'selected' : '' }}>
                                                DNI</option>
                                            ...
                                            <option value="PASAPORTE"
                                                {{ old('tipo_documento', $usuario->tipo_documento) == 'PASAPORTE' ? 'selected' : '' }}>PASAPORTE
                                            </option>
                                            <option value="RUC" {{ old('tipo_documento', $usuario->tipo_documento) == 'RUC' ? 'selected' : '' }}>
                                                RUC</option>
                                            <option value="CI" {{ old('tipo_documento', $usuario->tipo_documento) == 'CI' ? 'selected' : '' }}>CI
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('numero_documento', $usuario->numero_documento) }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('celular', $usuario->celular) }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" class="form-control" value="{{ old('fecha_nacimiento', $usuario->fecha_nacimiento) }}"
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('direccion', $usuario->direccion) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('contacto_nombre', $usuario->contacto_nombre) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ old('contacto_telefono', $usuario->contacto_telefono) }}" name="contacto_telefono"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ old('contacto_parentesco', $usuario->contacto_parentesco) }}" name="contacto_parentesco"
