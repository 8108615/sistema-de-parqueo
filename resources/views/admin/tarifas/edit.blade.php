                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="nombre" id="nombre" required>
                                            ...
                                            <option value="fin_de_semana" {{ old('nombre',$tarifa->nombre) == 'fin_de_semana' ? 'selected' : '' }}>Tarifa Fin de Semana</option>
                                            <option value="feriados" {{ old('nombre',$tarifa->nombre) == 'feriados' ? 'selected' : '' }}>Tarifa Feriados</option>
                                        </select>
                                    </div>
                                    @error('nombre')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="tipo" id="tipo" required>
                                            ...
                                            <option value="por_hora" {{ old('tipo',$tarifa->tipo) == 'por_hora' ? 'selected' : '' }}>Tarifa por Hora</option>
                                            <option value="por_dia" {{ old('tipo',$tarifa->tipo) == 'por_dia' ? 'selected' : '' }}>Tarifa por Día</option>
                                        </select>
                                    </div>
                                    @error('tipo')
                                        <small style="color: red;">*{{$message}}</small>
